  ...
  void _getStaticMap(String address,
    ...
    if (geocode) {
      final Uri uri = Uri.https(
        ...
        {'address': address, 'key': 'AIzaSyDXoJvN6cy9BEzDXeTMSk4yALYQhJ_qC5g'},
      );
    ...
    if (mounted) {
      final StaticMapProvider staticMapProvider =
          StaticMapProvider('AIzaSyDXoJvN6cy9BEzDXeTMSk4yALYQhJ_qC5g');
  ...
  Future<String> _getAddress(double lat, double lng) async {
    final uri = Uri.https(
      ...
      '/maps/api/geocode/json',
      {
        ...
        'key': 'AIzaSyDXoJvN6cy9BEzDXeTMSk4yALYQhJ_qC5g'
      },
    );
